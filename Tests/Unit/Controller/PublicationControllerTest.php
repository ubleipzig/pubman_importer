...
/**
 * Test case for class LeipzigUniversityLibrary\PubmanImporter\Controller\PublicationController.
 *
 */
class PublicationControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \LeipzigUniversityLibrary\PubmanImporter\Controller\PublicationController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('LeipzigUniversityLibrary\\PubmanImporter\\Controller\\PublicationController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPublicationsFromRepositoryAndAssignsThemToView() {
		...
		$publicationRepository = $this->getMock('LeipzigUniversityLibrary\\PubmanImporter\\Domain\\Repository\\PublicationRepository', array('findAll'), array(), '', FALSE);
