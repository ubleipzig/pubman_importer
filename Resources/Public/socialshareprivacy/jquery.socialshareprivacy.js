/* Switches und BILDPFADE geaendert CK */
/*
    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : 'fileadmin/Resources/socialshareprivacy/images/dummy_facebook.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'action'            : 'recommend',
                    'layout'            : 'button_count',
                    'sharer'            : {
                        'status'        : 'off',
                        'dummy_img'     : 'fileadmin/Resources/socialshareprivacy/images/dummy_facebook_share_de.png',
                        'img'           : 'fileadmin/Resources/socialshareprivacy/images/dummy_facebook_share_active_de.png'
                    }
                },
                'twitter' : {
                    'status'            : 'on',
                    'dummy_img'         : 'fileadmin/Resources/socialshareprivacy/images/dummy_twitter.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : 'fileadmin/Resources/socialshareprivacy/images/dummy_gplus.png',
                    'perma_option'      : 'on',
                    'referrer_track'    : '',
                    'size'              : 'medium'
                }
            ...
            'cookie_expires'    : '365',
            'css_path'          : 'fileadmin/Resources/socialshareprivacy/socialshareprivacy.css',
            'uri'               : getURI,
            'language'          : 'de',
            'lang_path'         : 'fileadmin/Resources/socialshareprivacy/lang/',
            'skin'              : 'light',
        ...
        return this.each(function () {
            ...
            .then( function() {
                ...
                if (facebook_on) {
                    ...
                    var fb_height = options.services.facebook.layout == 'box_count' ? '61' : '24';
                    ...
                    context.append('<li class="facebook help_info clearfix"><span class="info">' + language.services.facebook.txt_info + '</span><a href="#" class="switch small round off"><span>&nbsp;</span></a><div class="fb_like dummy_btn">' + fb_dummy_btn + '</div></li>');
                    ...
                    $(context).on('click', 'li.facebook div.fb_like img.fb_like_privacy_dummy,li.facebook .switch', function (e) {
                        ...
                        if ($container_fb.find('.switch').hasClass('off')) {
                            ...
                            $container_fb.find('.switch').addClass('on').removeClass('off');
                ...
                if (twitter_on) {
                    ...
                    var tw_height = options.services.twitter.count == 'horizontal' ? '24' : '62';
                    ...
                    context.append('<li class="twitter help_info clearfix"><span class="info">' + language.services.twitter.txt_info + '</span><a href="#" class="switch small round off"><span>&nbsp;</span></a><div class="tweet dummy_btn">' + twitter_dummy_btn + '</div></li>');
                    ...
                    $(context).on('click', 'li.twitter div.tweet img,li.twitter .switch', function (e) {
                        ...
                        if ($container_tw.find('.switch').hasClass('off')) {
                            ...
                            $container_tw.find('.switch').addClass('on').removeClass('off');
                ...
                if (gplus_on) {
                    ...
                    context.append('<li class="gplus help_info clearfix"><span class="info">' + language.services.gplus.txt_info + '</span><a href="#" class="switch small round off"><span>&nbsp;</span></a><div class="gplusone dummy_btn">' + gplus_dummy_btn + '</div></li>');
                    ...
                    $(context).on('click', 'li.gplus div.gplusone img,li.gplus .switch', function (e) {
                        ...
                        if ($container_gplus.find('.switch').hasClass('off')) {
                            ...
                            $container_gplus.find('.switch').addClass('on').removeClass('off');
                ...
                //
                context.append('<li class="settings_info ' + options.perma_orientation + '"><div class="settings_info_menu off perma_option_off"><span><a href="' + options.info_link + '"><span class="help_info icon"><span class="info">' + language.txt_help + '</span></span></a></div></li>');
